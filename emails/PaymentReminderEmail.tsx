...
export const PaymentReminderEmail = ({
  ...
  <Html>
    <Head />
    <Preview>Your Express Lyft ride is coming up — remaining balance due</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={header}>
          <Img src="https://booking.explyft.com/logo.png" width="200" alt="Express Lyft" style={logoImg} />
        </Section>
        <Heading style={h1}>Your Ride Is Coming Up</Heading>
        <Text style={text}>
          Dear {customerName}, your trip is scheduled soon. Please settle the remaining
          balance below so your chauffeur is ready to go.
        </Text>
