...
export default function MainMapBookingForm({ prices: serverPrices }: { prices: any }) {
  ...
  const handleResetForm = () => {
    setTripType(false ? 'round-trip' : 'one-way')
    setPickup('')
    setDestination('')
    setDate('')
    setTime('')
...
{/* Date + Time */}
              ...
              {step === 3 && (
                ...
                >
                  <h3 className="text-lg font-bold" style={{ color: '#FFFFFF' }}>
                    {false ? '2. Contact Info' : '3. Contact & Checkout'}
                  </h3>
                  ...
                  {/* Estimated Total */}
                  {true && vehicleType !== 'coachbus' && vehicleType !== 'minibus' && (
                    <>
                      <div
