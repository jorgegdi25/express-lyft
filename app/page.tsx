  ...
  return (
    <main style={{ background: 'var(--bg)', minHeight: '100vh', color: 'var(--text)' }}>
      ...
      <header
        ...
        style={{ background: 'rgba(17,17,17,0.88)', borderBottom: '1px solid var(--surface-alt)' }}
      >
        ...
        <div className="flex items-center gap-2 md:gap-4 lg:gap-6">
          {/* Schedule */}
          <div className="hidden xl:flex items-center gap-2 px-3 py-1.5 rounded-lg border border-[var(--border)] bg-[var(--surface)]">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--gold-light)" strokeWidth="2.5">
              <circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" />
            </svg>
            <span className="text-[11px] font-semibold text-[var(--text-subtle)] tracking-wide uppercase">
          ...
          <div className="hidden lg:flex flex-col items-end">
            <span className="text-[10px] uppercase tracking-[1px] font-semibold" style={{ color: 'var(--text-muted)' }}>
              Concierge Line
            </span>
            <a
              href="tel:+18889737896"
              className="text-sm font-bold hover:text-[var(--gold)] transition-colors"
          ...
          {/* CTA button */}
          <a href="https://wa.me/19546236207" target="_blank" rel="noopener noreferrer" className="px-3.5 md:px-5 py-2 rounded-xl text-xs md:text-sm font-bold uppercase tracking-wider transition-all hover:brightness-110 active:scale-95" style={{ background: 'linear-gradient(135deg, var(--gold), var(--gold-light))', color: 'var(--bg-deep)' }}>WhatsApp Us</a>
        </div>
      </header>
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: 'var(--text-subtle)' }}>
              ...
              <a href="tel:+18889737896" className="font-semibold underline" style={{ color: 'var(--gold-accent)' }}>
                Call +1 (888) 973-7896
              </a>{' '}
              or{' '}
      ...
      <section className="w-full py-16" style={{ background: 'var(--bg-alt-2)', borderRadius: '1rem', border: '1px solid var(--border-faint)' }}>
                <div className="max-w-7xl mx-auto px-4 md:px-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                    {/* Premium Ride */}
                    <div className="rounded-2xl p-8 flex flex-col items-center justify-between text-center transition-all duration-300 hover:border-[var(--gold)] hover:-translate-y-1 hover:shadow-lg hover:shadow-[#B8960C08]" style={{ background: 'var(--surface-raised)', border: '1px solid var(--border-faint)' }}>
                      <div>
                        <h3 className="text-xl font-bold text-white mb-2">Premium Ride</h3>
                        <p className="text-xs uppercase tracking-widest text-[var(--text-muted)] mb-4">Sedan & SUV</p>
                      </div>
                      <div className="my-6">
                        <span className="text-xs uppercase tracking-wider text-[var(--text-muted)]">Starting at</span>
                        <p className="text-5xl font-bold mt-1" style={{ color: 'var(--gold-accent)', fontFamily: "'Playfair Display', Georgia, serif" }}>${startingPrices.sedan_suv.base}</p>
                      </div>
                      <a
                    ...
                    <div className="rounded-2xl p-8 flex flex-col items-center justify-between text-center transition-all duration-300 hover:border-[var(--gold)] hover:-translate-y-1 hover:shadow-lg hover:shadow-[#B8960C08]" style={{ background: 'var(--surface-raised)', border: '1px solid var(--border-faint)' }}>
                      <div>
                        ...
                        <p className="text-xs uppercase tracking-widest text-[var(--text-muted)] mb-4">Chevy Suburban</p>
                      </div>
                      <div className="my-6">
                        <span className="text-xs uppercase tracking-wider text-[var(--text-muted)]">Starting at</span>
                        <p className="text-5xl font-bold mt-1" style={{ color: 'var(--gold-accent)', fontFamily: "'Playfair Display', Georgia, serif" }}>${startingPrices.suburban.base}</p>
                      </div>
                      <a
                        href="https://wa.me/19546236207" target="_blank" rel="noopener noreferrer"
                    ...
                    <div className="rounded-2xl p-8 flex flex-col items-center justify-between text-center transition-all duration-300 hover:border-[var(--gold)] hover:-translate-y-1 hover:shadow-lg hover:shadow-[#B8960C08]" style={{ background: 'var(--surface-raised)', border: '1px solid var(--border-faint)' }}>
                      <div>
                        ...
                        <p className="text-xs uppercase tracking-widest text-[var(--text-muted)] mb-4">Mercedes Sprinter</p>
                      </div>
                      <div className="my-6">
                        <span className="text-xs uppercase tracking-wider text-[var(--text-muted)]">Starting at</span>
                        <p className="text-5xl font-bold mt-1" style={{ color: 'var(--gold-accent)', fontFamily: "'Playfair Display', Georgia, serif" }}>${startingPrices.sprinter.base}</p>
                      </div>
                      <a
                        href="https://wa.me/19546236207" target="_blank" rel="noopener noreferrer"
                    ...
                    <div className="rounded-2xl p-8 flex flex-col items-center justify-between text-center transition-all duration-300 hover:border-[var(--gold)] hover:-translate-y-1 hover:shadow-lg hover:shadow-[#B8960C08]" style={{ background: 'var(--surface-raised)', border: '1px solid var(--border-faint)' }}>
                      <div>
                        ...
                        <p className="text-xs uppercase tracking-widest text-[var(--text-muted)] mb-4">Minibus & Coach Bus</p>
                      </div>
                      <div className="my-6">
                        <span className="text-xs uppercase tracking-wider text-[var(--text-muted)]">Rate</span>
                        <p className="text-3xl font-bold mt-1 leading-tight" style={{ color: 'var(--gold-accent)', fontFamily: "'Playfair Display', Georgia, serif" }}>Custom<br/>Quote</p>
                      </div>
                      <a
                        href="https://wa.me/19546236207" target="_blank" rel="noopener noreferrer"
                  ...
                  <p className="text-center text-lg mt-8 max-w-2xl mx-auto leading-relaxed font-bold" style={{ color: 'var(--gold-light)' }}>
      ...
      <section className="w-full py-16" style={{ background: 'var(--bg-alt-2)', borderRadius: '1rem', border: '1px solid var(--border-faint)' }}>
                <div className="max-w-7xl mx-auto px-4 md:px-6">
                  ...
                  <div className="max-w-3xl mx-auto flex flex-col gap-4">
                    <details name="faq-accordion" className="group rounded-2xl border border-[var(--border-faint)] bg-[var(--surface-raised)] overflow-hidden transition-all duration-300 [&_summary::-webkit-details-marker]:hidden">
                      <summary className="flex items-center justify-between p-6 cursor-pointer select-none font-bold text-base md:text-lg text-white hover:text-[var(--gold-light)] list-none">
                        <span>How far in advance can I make a reservation?</span>
                        <svg className="w-5 h-5 stroke-[var(--gold)] transition-transform duration-300 group-open:rotate-180 shrink-0 ml-4" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                          <polyline points="6 9 12 15 18 9"></polyline>
                        </svg>
                      </summary>
                      <div className="px-6 pb-6 text-sm md:text-base leading-relaxed text-[var(--text-subtle)] border-t border-[#1f1f1f] pt-4">
                    ...
                    <details className="group mt-2 overflow-hidden transition-all duration-300 [&_summary::-webkit-details-marker]:hidden">
                      <summary className="w-full py-4 text-center cursor-pointer select-none font-bold text-sm uppercase tracking-wider text-[var(--gold)] hover:text-[var(--gold-light)] transition-all border border-[var(--border-faint)] rounded-xl bg-[var(--surface-raised)] list-none hover:border-[var(--gold)]">
                        Show More Questions
                      </summary>
      ...
      <section id="explore" className="w-full py-12 animate-fade-in scroll-mt-20 md:scroll-mt-24" style={{ borderTop: '1px solid var(--surface)', background: 'var(--bg)' }}>
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-8">
            <p className="text-xs font-bold uppercase tracking-[3px] mb-2" style={{ color: 'var(--gold)' }}>
              Discover More
            </p>
            <h2 className="text-2xl md:text-4xl font-bold" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
            ...
            {[
              ...
              return (
                <Link
                  ...
                  style={{
                    background: isActive ? 'linear-gradient(135deg, var(--gold), var(--gold-light))' : 'var(--surface-raised)',
          ...
          <div className="flex flex-col gap-4 md:hidden px-4">
            <details name="explore-accordion" className="group rounded-2xl border border-[var(--border-faint)] bg-[var(--surface-raised)] overflow-hidden transition-all duration-300 [&_summary::-webkit-details-marker]:hidden">
              <summary className="flex items-center justify-between p-6 cursor-pointer select-none font-bold text-base text-white hover:text-[var(--gold-light)] list-none">
                <div className="flex items-center gap-3">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"></rect><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"></path></svg>
                  Our Services
                </div>
                <svg className="w-5 h-5 stroke-[var(--gold)] transition-transform duration-300 group-open:rotate-180 shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>
              </summary>
              <div className="px-4 pb-6 border-t border-[#1f1f1f] pt-4">
                <section className="w-full py-16" style={{ background: 'var(--surface-raised)', borderRadius: '1rem', border: '1px solid var(--border-faint)' }}>
                <div className="max-w-7xl mx-auto px-4 md:px-6">
                  <div className="text-center mb-12">
                    <p className="text-xs font-bold uppercase tracking-[3px] mb-3" style={{ color: 'var(--gold)' }}>
                      What We Do
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {/* Hotel Transfers */}
                    <div className="rounded-2xl p-6 transition-all duration-300 hover:border-[var(--gold)] hover:shadow-lg" style={{ background: 'var(--bg-alt-2)', border: '1px solid var(--border-faint)' }}>
                  ...
                  <div className="max-w-7xl mx-auto px-4 md:px-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                      {FEATURES.map((f) => (
                        <div
                          key={f.title}
                          className="rounded-2xl p-6 flex flex-col gap-4 transition-all duration-300 hover:border-[var(--gold)] hover:-translate-y-1 hover:shadow-lg hover:shadow-[#B8960C10]"
                          style={{ background: 'var(--bg-alt-2)', border: '1px solid var(--border-faint)' }}
                        >
                          <div
                ...
                <section className="w-full py-16" style={{ background: 'var(--bg-alt-2)', borderRadius: '1rem', border: '1px solid var(--border-faint)' }}>
                  <div className="max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
                    <div className="flex flex-col gap-5">
                      <p className="text-xs font-bold uppercase tracking-[3px]" style={{ color: 'var(--gold)' }}>
                        By the Numbers
                      </p>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {STATS.map((s) => (
                        <div
                          key={s.label}
                          className="rounded-2xl p-6 text-center flex flex-col gap-1 transition-all hover:border-[var(--gold)]"
                          style={{ background: 'var(--surface-raised)', border: '1px solid var(--border-faint)' }}
                        >
                          <p className="text-4xl md:text-5xl font-bold" style={{ color: 'var(--gold)', fontFamily: "'Playfair Display', Georgia, serif" }}>
                            {s.stat}
                          </p>
      ...
      {/* ── CTA banner ───────────────────────────────────────────── */}
      <section className="w-full py-16" style={{ borderTop: '1px solid var(--surface)' }}>
        <div className="max-w-3xl mx-auto px-4 md:px-6 text-center flex flex-col gap-6 items-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a
              href="tel:+18889737896"
              className="px-8 py-4 rounded-xl text-sm font-bold uppercase tracking-wider transition-all hover:border-[var(--gold)] hover:text-[var(--gold)] text-center"
      ...
      {/* ── Footer ───────────────────────────────────────────────── */}
      <footer className="w-full py-16" style={{ borderTop: '1px solid var(--surface-alt)', background: 'var(--bg-deep)' }}>
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-base font-bold leading-relaxed" style={{ color: 'var(--gold-accent)' }}>
            ...
            {/* Column 2: Locations */}
            <div className="flex flex-col gap-4">
              <h4 className="text-sm font-bold uppercase tracking-[2px]" style={{ color: 'var(--text)' }}>
                Our Locations
              </h4>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3 text-sm" style={{ color: 'var(--text-muted)' }}>
                <a href="tel:+18889737896" className="flex items-center gap-2 hover:text-[var(--gold)] transition-colors">
                ...
                <a href="mailto:info@explyft.com" className="flex items-center gap-2 hover:text-[var(--gold)] transition-colors">
                ...
                <div className="flex items-center gap-4 mt-2 pt-2 border-t border-[var(--surface)]">
                  <a
              ...
              <div className="flex gap-6 mt-4 pt-4" style={{ borderTop: '1px solid var(--surface-alt)' }}>
                <a href="/privacy" className="text-xs font-semibold hover:text-white transition-colors" style={{ color: 'var(--text-faint)' }}>
                  Privacy Policy
                </a>
                <a href="/terms" className="text-xs font-semibold hover:text-white transition-colors" style={{ color: 'var(--text-faint)' }}>
                  Terms of Service
                </a>
              </div>
            </div>
          ...
          <div
            ...
            style={{ borderTop: '1px solid var(--surface-alt)', color: '#555555' }}
          >
